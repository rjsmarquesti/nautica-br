...
const REVIEWER_CODE  = 'NAUTICABR2026'
    ...
    <KeyboardAvoidingView style={s.flex} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={[s.container, { paddingTop: insets.top + 24 }]} keyboardShouldPersistTaps="handled">
        <View style={s.logoBox}>
          <Image source={require('../assets/logo.png')} style={s.logoImg} resizeMode="contain" accessibilityRole="image" accessibilityLabel="Logo Náutica BR" />
          <Text style={s.logoNome}>Náutica BR</Text>
